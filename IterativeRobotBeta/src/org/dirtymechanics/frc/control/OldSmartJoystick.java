...
/**
 * A <CODE>Joystick</CODE> implementation with toggle switched buttons.
 *
 * @author Daniel Ruess
 */
public class OldSmartJoystick extends Joystick {

    private final Button[] buttons;

    public OldSmartJoystick(int id, int toggles[]) {
        super(id);
    ...
    public OldSmartJoystick(int id) {
        this(id, new int[]{});
    }
