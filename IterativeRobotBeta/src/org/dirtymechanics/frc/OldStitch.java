...
public class OldStitch {
    ...
    private final OldSmartJoystick gamepad;
    ...
    public OldStitch() {
        leftStick = new OldSmartJoystick(1);
        rightStick = new OldSmartJoystick(2);
        gamepad = new OldSmartJoystick(3);
    ...
    public void teleopPeriodic() {
        ...
        rightJaguarPair.set(rightStick.getY());
